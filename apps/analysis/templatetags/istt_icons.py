...
_P = {
    ...
    # 4.4-G: la llave inglesa del menu de moderacion (trazo fino, como el resto).
    'wrench': 'M14.5 6.5a4 4 0 0 0-5.3 5L3 17.7 6.3 21l6.2-6.2a4 4 0 0 0 5-5.3l-2.6 2.6-2.8-.7-.7-2.8z',
    'globe': 'M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0-18 0M3 12h18M12 3c2.5 2.6 2.5 15.4 0 18'
             'M12 3c-2.5 2.6-2.5 15.4 0 18',
    # 5.23 (ordenes de David): compartir agrupado, menu de tres puntos, modo
    # viajero y las acciones del menu — mismo trazo fino de contorno.
    'share': 'M18 5m-2.5 0a2.5 2.5 0 1 0 5 0a2.5 2.5 0 1 0-5 0M6 12m-2.5 0a2.5 2.5 0 1 0 5 0'
             'a2.5 2.5 0 1 0-5 0M18 19m-2.5 0a2.5 2.5 0 1 0 5 0a2.5 2.5 0 1 0-5 0'
             'M8.3 10.8l7.4-4.6M8.3 13.2l7.4 4.6',
    'dots': 'M12 5m-1.3 0a1.3 1.3 0 1 0 2.6 0a1.3 1.3 0 1 0-2.6 0M12 12m-1.3 0a1.3 1.3 0 1 0 2.6 0'
            'a1.3 1.3 0 1 0-2.6 0M12 19m-1.3 0a1.3 1.3 0 1 0 2.6 0a1.3 1.3 0 1 0-2.6 0',
    'columns': 'M3 5h4.5v14H3zM16.5 5H21v14h-4.5zM10 8h4M10 12h4M10 16h4',
    'link': 'M10 14a4 4 0 0 0 5.7 0l3-3a4 4 0 0 0-5.7-5.7l-1.5 1.5M14 10a4 4 0 0 0-5.7 0l-3 3'
            'a4 4 0 0 0 5.7 5.7l1.5-1.5',
    'lock': 'M6 11h12v9H6zM9 11V7a3 3 0 0 1 6 0v4',
    'unlock': 'M6 11h12v9H6zM9 11V7a3 3 0 0 1 6 0',
    'bookmark': 'M7 4h10v17l-5-4-5 4z',
    'folder': 'M3 6h6l2 2h10v11H3z',
    'edit': 'M4 20h4L19 9l-4-4L4 16zM13 7l4 4',
    'ban': 'M12 12m-8 0a8 8 0 1 0 16 0a8 8 0 1 0-16 0M6.5 6.5l11 11',
