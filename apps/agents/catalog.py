...
# id                       nombre visible        tier  in$/M  out$/M
CATALOG = [
    ('claude-haiku-4-5-20251001', 'Haiku 4.5',      1,   1.0,   5.0),
    ('claude-sonnet-4-6',         'Sonnet 4.6',     2,   3.0,  15.0),
    ('claude-opus-4-6',           'Opus 4.6',       3,   5.0,  25.0),
    ('claude-opus-4-7',           'Opus 4.7',       3,   5.0,  25.0),
    ('claude-opus-4-8',           'Opus 4.8',       4,   5.0,  25.0),
    ('claude-fable-5',            'Fable 5',        5,  10.0,  50.0),
]
